...
/**
 * <em>Internal-use-only</em> logger used by MimosaMQ.  <strong>DO NOT</strong>
 * access this class outside of MimosaMQ.
 */
public interface InternalLogger {
     ...
     * <p/>
     * <p>This form avoids superfluous object creation when the logger is disabled for the specified {@code level}. </p>
     *
     * @param format the format string
     * @param arg    the argument
     */
